...
sudo mysql -uroot -e "CREATE DATABASE Oluwanifemi;"
sudo mysql -uroot -e "CREATE USER 'Akintomide'@'localhost' IDENTIFIED BY 'loveth';"
sudo mysql -uroot -e "GRANT ALL PRIVILEGES ON Oluwanifemi.* TO 'Akintomide'@'localhost';"
cd /var/www/laravel
